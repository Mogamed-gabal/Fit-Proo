...
const exerciseSchema = new mongoose.Schema({
  ...
  equipment: {
    type: String,
    required: true,
    enum: ['stepmill machine','elliptical machine',
  'trap bar',
  'tire',
  'stationary bike',
  'wheel roller',
  ...
  'olympic barbell',
  'kettlebell',
  'upper body ergometer','sled machine','ez barbell','dumbbell','rope','barbell','band','stability ball','medicine ball','assisted','leverage machine','cable'],
    type: String,
    required: true,
    trim: true,
